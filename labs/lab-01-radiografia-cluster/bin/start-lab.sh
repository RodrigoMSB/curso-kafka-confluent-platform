...
# ============================================================
# NovaTech Logistics - Lab 01: Iniciar laboratorio
# ============================================================
...
echo "║                                                          ║"
echo "║     Lab 01: Radiografía de un clúster Kafka vivo         ║"
echo "║                                                          ║"
echo "╚══════════════════════════════════════════════════════════╝"
echo -e "${NC}"
...
echo -e "    Explorar clúster:    ${BOLD}bin/explore-cluster.sh${NC}"
echo -e "    Ver datos GPS:       ${BOLD}kafka-cli/consume-gps.sh${NC}"
echo -e "    Tumbar un broker:    ${BOLD}bin/kill-broker.sh <1|2|3>${NC}"
echo -e "    Revivir un broker:   ${BOLD}bin/revive-broker.sh <1|2|3>${NC}"
echo -e "    Detener laboratorio: ${BOLD}bin/stop-lab.sh${NC}"
echo ""
echo -e "${YELLOW}  Abre la guía: guia/01-exploracion-cluster.md${NC}"
echo ""
