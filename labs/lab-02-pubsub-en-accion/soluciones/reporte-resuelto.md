...
> **Nota para el instructor**: Las particiones exactas (especialmente en la Parte 5) pueden variar dependiendo del hash. Lo crítico es la consistencia: la MISMA clave siempre va a la MISMA partición.
